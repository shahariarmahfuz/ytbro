...
def home():
    ...
    <div style="font-family: sans-serif; text-align: center; padding-top: 50px;">
        <h2>YouTube Downloader (HQ with Docker & FFmpeg)</h2>
...
def download_video():
    ...
    # কুকি ফাইলের নাম (যেটি আপনি Docker ফোল্ডারে রেখেছেন)
    cookie_path = "cookies.txt"

    ydl_opts = {
        "outtmpl": filepath,
        # FFmpeg আছে তাই এখন আমরা সেরা ভিডিও+অডিও মার্জ করতে পারব
        "format": "bestvideo[ext=mp4]+bestaudio[ext=m4a]/best[ext=mp4]/best",
        "merge_output_format": "mp4",
        "quiet": True,
        # কুকি ফাইল ব্যবহার করার নির্দেশ
        "cookiefile": cookie_path,
    }

    try:
        # কুকি ফাইল চেক (সতর্কতার জন্য)
        if not os.path.exists(cookie_path):
            print("Warning: cookies.txt not found inside container!")
